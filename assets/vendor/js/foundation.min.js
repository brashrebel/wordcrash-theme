...
!function (t, e, i, s) {
    ...
    Foundation.libs.abide = {
        ...
        check_validation_and_apply_styles: function (e) {
            ...
            for (n.data(this.attr_name(!0) + "-init") || {}; i--;) {
                var a, o, r = e[i][0], l = e[i][2], d = r.value.trim(), h = this.S(r).parent(), c = r.getAttribute(this.add_namespace("data-abide-validator")), u = "radio" === r.type, f = "checkbox" === r.type, p = this.S('label[for="' + r.getAttribute("id") + '"]'), g = l ? r.value.length > 0 : !0, _ = [];
                if (r.getAttribute(this.add_namespace("data-equalto")) && (c = "equalTo"), a = h.is("label") ? h.parent() : h, u && l)_.push(this.valid_radio(r, l)); else if (f && l)_.push(this.valid_checkbox(r, l)); else if (c) {
    ...
    Foundation.libs.accordion = {
        ...
        events: function (e) {
            ...
            i.create(this.S(e)), s(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a, [" + this.attr_name() + "] > li > a", function (e) {
                var n = s(this).closest("[" + i.attr_name() + "]"), a = i.attr_name() + "=" + n.attr(i.attr_name()), o = n.data(i.attr_name(!0) + "-init") || i.settings, r = s("#" + this.href.split("#")[1]), l = t("> dd, > li", n), d = l.children("." + o.content_class), h = d.filter("." + o.active_class);
    ...
    Foundation.libs.clearing = {
        ...
        open: function (e, s, n) {
            ...
            var r = this, l = t(i.body), d = n.closest(".clearing-assembled"), h = r.S("div", d).first(), c = r.S(".visible-img", h), u = r.S("img", c).not(e), f = r.S(".clearing-touch-label", h), p = !1, g = {};
        ...
        shift: function (t, e, i) {
            var s, n = e.parent(), a = this.settings.prev_index || e.index(), o = this.direction(n, t, e), r = this.rtl ? "right" : "left", l = parseInt(n.css("left"), 10), d = e.outerWidth(), h = {};
 ...
 */
    !function (t) {
        ...
        var o = /\+/g, r = t.cookie = function (n, o, l) {
            ...
            for (var c = n ? void 0 : {}, u = document.cookie ? document.cookie.split("; ") : [], f = 0, p = u.length; p > f; f++) {
                var g = u[f].split("="), _ = i(g.shift()), m = g.join("=");
                if (n && n === _) {
                    c = a(m, o);
                    break
                }
    ...
    Foundation.libs["magellan-expedition"] = {
        ...
        events: function () {
            ...
            e.set_expedition_position(), i(e.scope).off(".magellan").on("click.fndtn.magellan", "[" + e.add_namespace("data-magellan-arrival") + "] a[href*=#]", function (i) {
                ...
                if (s && n && a) {
                    i.preventDefault();
                    var r = t(this).closest("[" + e.attr_name() + "]"), l = r.data("magellan-expedition-init"), d = this.hash.split("#").join(""), h = t('a[name="' + d + '"]');
                    0 === h.length && (h = t("#" + d));
                    var c = h.offset().top - l.destination_threshold + 1;
                    l.offset_by_height && (c -= r.outerHeight()), t("html, body").stop().animate({scrollTop: c}, l.duration, l.easing, function () {
    ...
    Foundation.libs.slider = {
        ...
        set_ui: function (e, i) {
            var s = t.data(e[0], "settings"), n = t.data(e[0], "handle_l"), a = t.data(e[0], "bar_l"), o = this.normalized_percentage(i, s.start, s.end), r = o * (a - n) - 1, l = 100 * o, d = e.parent(), h = e.parent().children("input[type=hidden]");
    ...
    Foundation.libs.tab = {
        name: "tab", version: "5.5.2", settings: {
            ...
            var o = this, r = o.S, l = n.closest("[" + this.attr_name() + "]"), d = n.find("a"), h = n.children("a").first(), c = "#" + h.attr("href").split("#")[1], u = r(c), f = n.siblings(), p = l.data(this.attr_name(!0) + "-init"), g = function (e) {
